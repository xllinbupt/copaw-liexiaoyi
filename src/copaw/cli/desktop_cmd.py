# -*- coding: utf-8 -*-
"""CLI command: run Talora app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run Talora app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing Talora app instance.
    """
    ...
    click.echo(f"Starting Talora app on {url} (port {port})")
