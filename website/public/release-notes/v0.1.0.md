...
- **Guidance Skill**: Added a built-in skill that answers Talora installation and configuration questions using local docs and the official website ([#1522](https://github.com/agentscope-ai/CoPaw/pull/1522))
...
- **`copaw update` Command**: Added `copaw update` and `copaw shutdown` CLI commands. `copaw update` automatically detects the environment and upgrades Talora from PyPI ([#1278](https://github.com/agentscope-ai/CoPaw/pull/1278))
