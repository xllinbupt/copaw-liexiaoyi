...
Talora 支持**多智能体**，允许您在同一个 Talora 实例中运行多个独立的 AI 智能体。
...
简单来说，**多智能体**就是让您可以在一个 Talora 中运行多个"分身"，每个分身：
...
启动 Talora 后，在控制台**左上角**可以看到**智能体切换器**：
...
如果您之前使用 Talora **v0.0.x**，升级到 **v0.1.0** 时会**自动迁移**：
