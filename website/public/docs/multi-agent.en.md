...
Talora supports **multi-agent**, allowing you to run multiple independent AI agents in a single Talora instance.
...
Simply put, **multi-agent** lets you run multiple "personas" in one Talora, where each persona:
...
You might use Talora across multiple platforms:
...
After starting Talora, you'll see the **Agent Selector** in the **top-left corner** of the console:
...
If you previously used Talora **v0.0.x**, upgrading to **v0.1.0** will **automatically migrate**:
...
2. **Verify Migration**
   ...
   - After starting Talora, check the agent list in console
   - You should see an agent named "Talora"
