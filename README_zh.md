...
>
> **Skills 扩展** — 内置招聘场景技能，可自动加载本地自定义 skill。当前已接入 `duolie_talent`，支持在多猎系统里搜索人才和查看简历详情。
>
...
> <br>
>
> - **人才搜寻**：按岗位关键词、城市、年限、学校、公司背景等维度生成搜索条件并检索候选人。
> - **简历查看**：通过内置 `duolie_talent` skill 直接查看候选人完整简历详情。
